  ...
  <div class="vinyl-player">
    ...
    <div class="sticker-zones">
      ...
      <div class="sticker-zone zone-1" :class="{ 'has-sticker': stickerZones[0] }" style="--position: 0;">
        <img v-if="stickerZones[0]" :src="getStickerImage(stickerZones[0])" :alt="stickerZones[0]" class="zone-sticker" />
      </div>
      <div class="sticker-zone zone-2" :class="{ 'has-sticker': stickerZones[1] }" style="--position: 1;">
        <img v-if="stickerZones[1]" :src="getStickerImage(stickerZones[1])" :alt="stickerZones[1]" class="zone-sticker" />
      </div>
      <div class="sticker-zone zone-3" :class="{ 'has-sticker': stickerZones[2] }" style="--position: 2;">
        <img v-if="stickerZones[2]" :src="getStickerImage(stickerZones[2])" :alt="stickerZones[2]" class="zone-sticker" />
      </div>
      <div class="sticker-zone zone-4" :class="{ 'has-sticker': stickerZones[3] }" style="--position: 3;">
        <img v-if="stickerZones[3]" :src="getStickerImage(stickerZones[3])" :alt="stickerZones[3]" class="zone-sticker" />
      </div>
      <div class="sticker-zone zone-5" :class="{ 'has-sticker': stickerZones[4] }" style="--position: 4;">
        <img v-if="stickerZones[4]" :src="getStickerImage(stickerZones[4])" :alt="stickerZones[4]" class="zone-sticker" />
      </div>
      <div class="sticker-zone zone-6" :class="{ 'has-sticker': stickerZones[5] }" style="--position: 5;">
        <img v-if="stickerZones[5]" :src="getStickerImage(stickerZones[5])" :alt="stickerZones[5]" class="zone-sticker" />
      </div>
    </div>
